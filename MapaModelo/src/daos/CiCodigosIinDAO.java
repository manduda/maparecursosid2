...
public class CiCodigosIinDAO {
    ...
    public static void transferirCodigosIin(String operadorOrigen, String operadorDestino, EntityManager em){

        String searchQuery = "UPDATE CI_CODIGOS_IIN SET SK_EMPRESA_CODE = ?1 WHERE SK_EMPRESA_CODE = ?2";
